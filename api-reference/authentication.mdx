---
title: "Authenticate Your TinyTrack API Requests with API Keys"
sidebarTitle: "Authentication"
description: "Generate an API key in your TinyTrack dashboard and pass it as a Bearer token in the Authorization header on every API request you make."
---
